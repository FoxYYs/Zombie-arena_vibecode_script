Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/FoxYYs/Zombie-arena_vibecode_script/refs/heads/main/vibecoded_menu.lua"))()
...
-- Логика Noclip (универсальная и неубиваемая)
local noclip = false
